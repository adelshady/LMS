...
//        public AdminsController(ApplicationDbContext db, IWebHostEnvironment _webHostEnvironment)
//        {
//            this.db = db;
...
//        {
//            var admin = db.users.Include(x => x.Level).Include(x => x.Level.Stage).Include(x => x.Level.Stage.Section).Where(x => x.JobType == "Admin").ToList();
//            return View();
//        }
...
//        public async Task<ActionResult> Create(IFormCollection collection , Student user)
//        {
...
//        [HttpPost]
//        [ValidateAntiForgeryToken]
//        public async Task<ActionResult> Edit(int ID, IFormCollection collection, Student users)
//        {
