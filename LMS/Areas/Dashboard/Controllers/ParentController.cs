...
//            var SectionID = Parent.Level.Stage.SectionId;
//            var StageID = Parent.Level.StageId;
...
//        public async Task<ActionResult> Create(Student user,IFormCollection collection)
//        {
